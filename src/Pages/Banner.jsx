    ...
    >
      <div className="flex justify-between items-center text-black p-5">
        <div>
          ...
          <button className="px-6 py-2 bg-white border-2 border-[#754DE8] rounded-2xl">Start Creating</button>
        </div>
        <div>
        <button className="px-3 mb-6 mt-3 py-2 ml-96 bg-white border-2  rounded-2xl flex items-center gap-2"><span>Zara ventus</span> <span><AiFillCaretDown/></span></button>
          <h1 className="mb-4">
